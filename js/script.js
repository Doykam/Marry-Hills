...
const CHARACTERS = [
  {
    ...
    desc: ["ดำรงหน้าที่ในสถานะนายอำเภอคนปัจจุบันของเทศบาลเมืองแมรี่ฮิลล์<br>เขาเป็นคนที่อัธยาศัยดีเป็นที่รักของเหล่าพนักงานรัฐและชาวเมือง<br>ถึงแม้จะปฏิบัติหน้าที่ได้ไม่นานนักแต่ผลงานเขาทำให้ชาวเมืองวางใจ<br><br>เป็นชายร่างสูงโปร่ง ผมสีน้ำตาเฮเซล นัยน์ตาสีฟ้าคราม<br>มักอยู่ในชุดที่สุภาพสอาดสะอ้านและมีท่าทีที่ดีเสมอ<br>เขาเป็นนายอำเภอที่พึ่งพาได้"],
  },
  {
    name: "ตัวละคร 2",
    letter: "2",
